            ...
            (i.fn = i.prototype =
              {
                ...
                position: function () {
                  ...
                  var e = this[0],
                    t = t.apply(e),
                    n = this.offset(),
                    a = /^(?:body|html)Rs./i.test(t.nodeName)
                      ? { top: 0, left: 0 }
                      : i(t).offset();
                  return (
        ...
        return (function (t, e, i, n) {
          ...
          function s(t, e) {
            ...
            return (
              ...
              !1 === i &&
                (i = v.Easings[v.defaults.easing] ? v.defaults.easing : m),
              i
            );
          }
          function l(t) {
            if (t) {
              ...
              for (var a = 0; i > a; a++)
                if (v.State.calls[a]) {
                  ...
                  for (
                    var m = Math.min((e - h) / c.duration, 1),
                      b = 0,
                      x = s.length;
                    x > b;
                    b++
                  ...
                  c.display !== n &&
                    "none" !== c.display &&
                    (v.State.calls[a][2].display = !1),
                    c.visibility !== n &&
                      "hidden" !== c.visibility &&
                      (v.State.calls[a][2].visibility = !1),
                    c.progress &&
                      c.progress.call(
                        o[1],
                        o[1],
          ...
          var d,
            ...
            f = {
              ...
              isNodeList: function (t) {
                return (
                  "object" == typeof t &&
                  /^\[object (HTMLCollection|NodeList|Object)\]Rs./.test(
          ...
          if (!(7 >= c)) {
            ...
            var y = (v.CSS = {
              RegEx: {
                isHex: /^#([A-f\d]{3}){1,2}Rs./i,
                valueUnwrap: /^[A-z]+\((.*)\)Rs./i,
                wrappedValueAlreadyExtracted:
                  /[0-9.]+ [0-9.]+ [0-9.]+( [0-9.]+)?/,
                valueSplit: /([A-z]+\(.+\))|(([A-z0-9#-.]+?)(?=\s|Rs.))/gi,
              },
              Lists: {
                colors: [
                  "fill",
                        ...
                        switch (t) {
                          ...
                          case "inject":
                            ...
                            switch (e.substr(0, e.length - 1)) {
                              case "translate":
                                o = !/(%|px|em|rem|vw|vh|\d)Rs./i.test(a);
                                break;
                              case "scal":
                              case "scale":
                                v.State.isAndroid &&
              ...
              Names: {
                ...
                SVGAttribute: function (t) {
                  ...
                  return (
                    (c || (v.State.isAndroid && !v.State.isChrome)) &&
                      (e += "|transform"),
                    new RegExp("^(" + e + ")Rs.", "i").test(t)
                  );
                },
              ...
              Values: {
                hexToRgb: function (t) {
                  ...
                  return (
                    (t = t.replace(
                      /^#?([a-f\d])([a-f\d])([a-f\d])Rs./i,
                      function (t, e, i, n) {
                        return e + e + i + i + n + n;
                      }
                    )),
                    (e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})Rs./i.exec(t))
                      ? [
                          parseInt(e[1], 16),
                          parseInt(e[2], 16),
                          parseInt(e[3], 16),
                ...
                isCSSNullValue: function (t) {
                  return (
                    0 == t ||
                    /^(none|auto|transparent|(rgba\(0, ?0, ?0, ?0\)))Rs./i.test(
                      t
                    )
                  );
                },
                getUnitType: function (t) {
                  return /^(rotate|skew)/i.test(t)
                    ? "deg"
                    : /(^(scale|scaleX|scaleY|scaleZ|alpha|flexGrow|flexHeight|zIndex|fontWeight)Rs.)|((opacity|red|green|blue|alpha)Rs.)/i.test(
                        t
                      )
                    ? ""
                    : "px";
                ...
                getDisplayType: function (t) {
                  ...
                  return /^(b|big|i|small|tt|abbr|acronym|cite|code|dfn|em|kbd|strong|samp|var|a|bdo|br|img|map|object|q|script|span|sub|sup|button|input|label|select|textarea)Rs./i.test(
                    e
                  )
                    ? "inline"
                    : /^(li)Rs./i.test(e)
              ...
              getPropertyValue: function (t, i, a, o) {
                function s(t, i) {
                  ...
                  if ("auto" === l && /^(top|right|bottom|left)Rs./i.test(i)) {
                    var g = s(t, "position");
                    ("fixed" === g ||
            ...
            var x = function () {
              ...
              function o() {
                function t(t) {
                  ...
                  if ("scroll" === P) {
                    ...
                    d.each(b, function (t, e) {
                      if (
                        RegExp("^" + y.Lists.colors.join("Rs.|^") + "Rs.").test(
                          t
                        )
                      ) {
                        var i = h(e, !0),
                    ...
                    b)) {
                      ...
                      if (
                        r(o).isSVG ||
                        "tween" === W ||
                        !1 !== y.Names.prefixCheck(W)[1] ||
                        y.Normalizations.registered[W] !== n
                      ) {
                        ((u.display !== n &&
                          null !== u.display &&
                          "none" !== u.display) ||
                          ...
                          u._cacheValues && _ && _[O]
                            ? (E === n && (E = _[O].endValue + _[O].unitType),
                              (B = r(o).rootPropertyValueCache[W]))
                            : y.Hooks.registered[O]
                            ? E === n
                              ? ((B = y.getPropertyValue(o, W)),
                                (E = y.getPropertyValue(o, O, B)))
                        ...
                        if (
                          ...
                          (z = parseFloat(z) || 0),
                          "%" === j &&
                            (/^(fontSize|lineHeight)Rs./.test(O)
                              ? ((z /= 100), (j = "em"))
                              : /^scale/.test(O)
                              ? ((z /= 100), (j = ""))
                              : /(Red|Green|Blue)Rs./i.test(O) &&
                                ((z = (z / 100) * 255), (j = ""))),
                          /[\/*]/.test(Y))
                        )
                          j = q;
                  ...
                  c.element &&
                    ...
                    (r(o).isAnimating = !0),
                    C === S - 1
                      ? (v.State.calls.push([R, m, u, null, T.resolver]),
                        !1 === v.State.isTicking &&
                ...
                !1 !== v.mock &&
                  ...
                  u.display !== n &&
                    ...
                    "auto" === u.display &&
                      (u.display = v.CSS.Values.getDisplayType(o))),
                  u.visibility !== n &&
                    null !== u.visibility &&
                    (u.visibility = u.visibility.toString().toLowerCase()),
                  (u.mobileHA =
                    u.mobileHA && v.State.isMobile && !v.State.isGingerbread),
                  !1 === u.queue
                    ? u.delay
              ...
              if (
                ...
                var S = m.length,
                  C = 0;
                if (!/^(stop|finish)Rs./i.test(b) && !d.isPlainObject(w)) {
                  w = {};
                  for (var M = p + 1; M < arguments.length; M++)
                    f.isArray(arguments[M]) ||
                    (!/^(fast|normal|slow)Rs./i.test(arguments[M]) &&
                      !/^\d/.test(arguments[M]))
                ...
                var P,
                  T = { promise: null, resolver: null, rejecter: null };
                switch (
                  (c &&
                    v.Promise &&
                    (T.promise = new v.Promise(function (t, e) {
                  ...
                  case "stop":
                    ...
                    var A = [];
                    return (
                      d.each(v.State.calls, function (t, e) {
                        e &&
                  ...
                  default:
                    if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                      ...
                      return (
                        T.promise ? T.rejecter(new Error(D)) : console.log(D),
                        t()
                      );
                    }
                    P = "start";
                ...
                if (
                  ...
                  ((O = d.extend({}, v.defaults, w)).loop = parseInt(O.loop)),
                  (F = 2 * O.loop - 1),
                  O.loop)
                )
                  for (var V = 0; F > V; V++) {
          ...
          function (t, e, i) {
            ...
            function a(t) {
              if (t) {
                var e = [0, 0, 0],
                  i = 1,
                  a = t.match(/^#([a-fA-F0-9]{3})Rs./i);
                if (a) {
                  a = a[1];
                  for (var r = 0; r < e.length; r++)
                    e[r] = parseInt(a[r] + a[r], 16);
                } else if ((a = t.match(/^#([a-fA-F0-9]{6})Rs./i))) {
                  a = a[1];
                    ...
                    return (
                      isNaN(a.rotation)
                        ? (isNaN(n.pointRotation) &&
                            !r.isArray(n.pointRotation)) ||
                          (i = r.valueAtIndexOrDefault(n.pointRotation, e, i))
                        : (i = a.rotation),
                      i
                    );
                  },
              ...
              (e.exports = function (t) {
                t.controllers.polarArea = t.DatasetController.extend({
                  ...
                  update: function (t) {
                    ...
                    for (
                      a._updateRadius(),
                        s.count = a.countVisibleElements(),
                        e = 0,
                        i = o.data.length;
                      e < i;
                      e++
            ...
            n._set("global", {
              ...
              (e.exports = {
                ...
                requestAnimationFrame: function () {
                  var t = this;
                  null === t.request &&
                    (t.request = a.requestAnimFrame.call(window, function () {
                  ...
                  for (var e, i, n = this.animations, r = 0; r < n.length; )
                    (i = (e = n[r]).chart),
                      ...
                      e.currentStep >= e.numSteps
                        ? (a.callback(e.onAnimationComplete, [e], i),
                          (i.animating = !1),
                          n.splice(r, 1))
                        : ++r;
                },
                ...
                o.extend(t.prototype, {
                  ...
                  resize: function (t) {
                    var e = this,
                      ...
                      s = Math.max(
                        0,
                        Math.floor(a ? r / a : o.getMaximumHeight(n))
                      );
                    if (
                  ...
                  buildOrUpdateScales: function () {
                    ...
                    i.scales &&
                      ...
                      o.each(a, function (i) {
                        ...
                        e(a.position) !== e(i.dposition) &&
                          (a.position = i.dposition),
                          (r[s] = !0);
                        var u = null;
                  ...
                  updateLayout: function () {
                    !1 !== d.notify(this, "beforeLayout") &&
                      (l.update(this, this.width, this.height),
                      d.notify(this, "afterScaleUpdate"),
                      d.notify(this, "afterLayout"));
                  },
                  ...
                  updateDataset: function (t) {
                    var e = this.getDatasetMeta(t),
                      i = { meta: e, index: t };
                    !1 !== d.notify(this, "beforeDatasetUpdate", [i]) &&
                      (e.controller.update(),
                      d.notify(this, "afterDatasetUpdate", [i]));
                  },
                  render: function (t) {
                    var e = this;
                    (t && "object" == typeof t) ||
                  ...
                  drawDataset: function (t, e) {
                    ...
                    !1 !== d.notify(this, "beforeDatasetDraw", [n]) &&
                      (i.controller.draw(e),
                      d.notify(this, "afterDatasetDraw", [n]));
                  },
                  _drawTooltip: function (t) {
                    var e = this.tooltip,
                      i = { tooltip: e, easingValue: t };
                    !1 !== d.notify(this, "beforeTooltipDraw", [i]) &&
                      (e.draw(), d.notify(this, "afterTooltipDraw", [i]));
                  },
              ...
              (t.DatasetController = function (t, e) {
                ...
                n.extend(t.DatasetController.prototype, {
                  ...
                  removeHoverStyle: function (t) {
                    n.merge(t._model, t.Rs.previousStyle || {}),
                      delete t.Rs.previousStyle;
                  },
                  setHoverStyle: function (t) {
                    var e = this.chart.data.datasets[t._datasetIndex],
                      i = t._index,
          ...
          function (t, e, i) {
            ...
            e.exports = function () {
              ...
              function i(i, n, a) {
                ...
                return d || c
                  ? Math.min(d ? t(l, i, a) : h, c ? t(u, s, a) : h)
                  : "none";
              }
              (r.configMerge = function () {
                  ...
                  [].slice.call(arguments, 1),
                  {
                    merger: function (t, e, i, n) {
                      ...
                      "scales" === t
                        ...
                        : "scale" === t
                        ? (e[t] = r.merge(a, [o.getScaleDefaults(s.type), s]))
                        : r._merger(t, e, i, n);
                    },
                  }
                );
                ...
                (r.getMaximumWidth = function (t) {
                  ...
                  var i = e.clientWidth,
                    n =
                      i -
                      r._calculatePadding(e, "padding-left", i) -
                      r._calculatePadding(e, "padding-right", i),
                ...
                (r.getMaximumHeight = function (t) {
                  ...
                  var i = e.clientHeight,
                    n =
                      i -
                      r._calculatePadding(e, "padding-top", i) -
                      r._calculatePadding(e, "padding-bottom", i),
            ...
            n._set("global", { plugins: {} }),
              (e.exports = {
                ...
                descriptors: function (t) {
                  var e = t.Rs.plugins || (t.Rs.plugins = {});
              ...
              (e.exports = a.extend({
                ...
                calculateTickRotation: function () {
                  ...
                  if (n.length && t.options.display && t.isHorizontal())
                    for (
                      var l,
                        u = r.longestText(e, a.font, n, t.longestTextCache),
                        c = u,
                ...
                fit: function () {
                  ...
                  if (
                    ((e.width = f
                      ...
                      ? g
                      : 0),
                    (e.height = f ? (h && l.drawTicks ? g : 0) : t.maxHeight),
                    o.display && h)
                  ) {
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    var a = e.ctx,
                      ...
                      _ =
                        "bottom" === i.position ? e.top + T : e.bottom - w - T,
                      D =
                        "bottom" === i.position ? e.top + T + w : e.bottom + T;
                    if (
                      (r.each(m, function (n, a) {
                        if (!r.isNullOrUndef(n.label)) {
                          ...
                          i.offset === h.offsetGridLines
                            ...
                            : ((u = r.valueAtIndexOrDefault(h.lineWidth, a)),
                              (d = r.valueAtIndexOrDefault(h.color, a)),
                              (c = r.valueOrDefault(
                                h.borderDash,
                                o.borderDash
                              )),
                          ...
                          if (g) {
                            ...
                            s.mirror
                              ? ((V = H ? "left" : "right"), (B = N))
                              : ((V = H ? "right" : "left"), (B = w + N)),
                              (O = H ? e.right - B : e.left + B);
                      ...
                      r.each(P, function (t) {
                        if (
                          ...
                          a.save(),
                            ...
                            a.rotate(t.rotation),
                            (a.font = t.major ? x.font : b.font),
                            (a.fillStyle = t.major ? y : v),
                          ...
                          if (r.isArray(i))
                            for (
                              var n = i.length,
                                o = 1.5 * b.size,
                                l = e.isHorizontal() ? 0 : (-o * (n - 1)) / 2,
                                u = 0;
                              u < n;
                              ++u
                            )
                              a.fillText("" + i[u], 0, l), (l += o);
                    ...
                    if (h.drawBorder) {
                      ...
                      g
                        ? ((E = W = "top" === i.position ? e.bottom : e.top),
                          (E += B),
                          (W += B))
                        : ((z = N = "left" === i.position ? e.right : e.left),
                          (z += B),
                          (N += B)),
                        a.beginPath(),
                        a.moveTo(z, E),
                  ...
                  h.filter &&
                    ...
                    (b = (function (t, e, i, n) {
                      ...
                      return (
                        ...
                        "top" === d
                          ? (r += c)
                          : (r -= "bottom" === d ? e.height + c : e.height / 2),
                        "center" === d
                          ? "left" === u
                            ? (a += c)
                            : "right" === u && (a -= c)
                ...
                draw: function (t) {
                  ...
                  e.skip ||
                    ((void 0 === t ||
                      ...
                      r.canvas.drawPoint(a, s, u, d, c, l)));
                },
              }));
          },
          { 26: 26, 27: 27, 46: 46 },
                    ...
                    switch (
                      ...
                      case "rectRounded":
                        var h = i / Math.SQRT2,
                          ...
                          p = -h,
                          g = Math.SQRT2 * i;
                        this.roundedRect(t, f, p, g, g, 0.425 * i);
                        break;
                      case "rectRot":
                        (c = (1 / Math.SQRT2) * i),
                          t.moveTo(-c, 0),
                  ...
                  r.each(t.legendItems, function (n, l) {
                    ...
                    x
                      ? m + g >= s &&
                        ((v = d.y += w),
                        d.line++,
                        (m = d.x = t.left + (s - u[d.line]) / 2))
                      : v + w > t.bottom &&
                        ((m = d.x = m + t.columnWidths[d.line] + i.padding),
                        (v = d.y = t.top + i.padding),
                        d.line++),
                      (function (t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
                          c.save(),
                    ...
                    r = (t.ticks = (function (t, e) {
                      ...
                      if (t.stepSize && t.stepSize > 0) r = t.stepSize;
                        ...
                        (r = n.niceNum(s / (t.maxTicks - 1), !0)),
                          void 0 !== (a = t.precision) &&
                            ((i = Math.pow(10, a)), (r = Math.ceil(r * i) / i));
                      }
                      ...
                      n.isNullOrUndef(t.min) ||
                        ...
                        !t.stepSize ||
                        (n.almostWhole((t.max - t.min) / t.stepSize, r / 1e3) &&
                          ((l = t.min), (u = t.max)));
                      var d = (u - l) / r;
                      (d = n.almostEquals(d, Math.round(d), r / 1e3)
                        ...
                        (a = 1),
                        r < 1 &&
                          ((a = Math.pow(10, 1 - Math.floor(n.log10(r)))),
                          (l = Math.round(l * a) / a),
                          (u = Math.round(u * a) / a)),
                        o.push(void 0 !== t.min ? t.min : l);
                      for (var c = 1; c < d; ++c)
                      ...
                      if (l > 0 || r.reverse) {
                        ...
                        if (
                          ...
                          if (
                            ((u.font = v),
                            u.save(),
                            u.translate(t.xCenter, t.yCenter),
                            u.rotate(f),
                            r.showLabelBackdrop)
                          ) {
                            ...
                            (u.fillStyle = r.backdropColor),
                              u.fillRect(
                                -h / 2 - r.backdropPaddingX,
                                -d - p / 2 - r.backdropPaddingY,
                                h + 2 * r.backdropPaddingX,
            ...
            function b(t, e, i, a) {
              ...
              for (
                f ||
                  ...
                  b = b.startOf(p ? "day" : l),
                  (y = y.startOf(p ? "day" : l)) < e && y.add(1, l),
                  o = n(b),
                  g &&
                    h &&
                    !p &&
                    !s.round &&
                    (o.startOf(h), o.add(~~((b - o) / (m.size * f)) * f, l));
                o < y;
                o.add(f, l)
              )
                x.push(+o);
              ...
              var t = o.extend({
                ...
                determineDataLimits: function () {
                  ...
                  w.length &&
                    ...
                    (d._table = []),
                    (d._timestamps = { data: y, datasets: x, labels: w });
                },
                buildTicks: function () {
                  var t,
                    e,
  ...
  (function (t, e) {
    ...
    function r(t) {
      ...
      return "[object String]" === r
        ? e(t)
        : a(t) &&
          /^\[object (Array|HTMLCollection|NodeList|Object)\]Rs./.test(r) &&
    ...
    var c = {
      ...
      allowEvent: function (t) {
        var e = !0;
        return (
          /^(mousedown|mousemove)Rs./.test(t.type) && c.touches && (e = !1), e
        );
      },
      registerEvent: function (t) {
        ...
        "touchstart" === e
          ? (c.touches += 1)
          : /^(touchend|touchcancel)Rs./.test(e) &&
            setTimeout(function () {
  ...
  (function (t) {
    t("body").on("shown.bs.modal", ".modal", function () {
      t(".modal-backdrop").length ||
        ((Rs.modal_dialog = t(this).children(".modal-dialog")),
        Rs.modal_dialog.hasClass("modal-side") &&
          (t(this).addClass("modal-scrolling"),
          t("body").addClass("scrollable")),
        Rs.modal_dialog.hasClass("modal-frame") &&
...
!(function (t) {
  t(".input-default-wrapper").on("change", ".input-default-js", function (e) {
    var i = t(e.target),
      ...
      r = "";
    a && a.length > 1
      ? (r = (i.attr("data-multiple-target") || "").replace(
          "{target}",
          a.length
        ))
      : e.target.value && (r = e.target.value.split("\\").pop()),
      r ? n.find(".span-choose-file").html(r) : n.html(n.html());
  });
})(jQuery);
